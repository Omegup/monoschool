...
export const ArrangeCircleVertical = ({
  ...
  return (
    ...
    >
      {bold ? (
        ...
        <>
          <path
            d="M13.3201 5.84998L16.36 8.88998"
            stroke={color}
            stroke-width="1.5"
          ...
          />
          <path
            d="M9.68001 16.15L6.64001 13.11"
            stroke={color}
            stroke-width="1.5"
            stroke-miterlimit="10"
            stroke-linecap="round"
