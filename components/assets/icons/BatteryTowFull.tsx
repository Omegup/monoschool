    ...
    >
      {bold ? (
        <>
          ...
          />
          <path
            d="M11.43 0.789062H5.85C1.75 0.789062 0.5 2.03906 0.5 6.1391V9.8591C0.5 13.9591 1.75 15.2091 5.85 15.2091H11.43C15.53 15.2091 16.78 13.9591 16.78 9.8591V6.1391C16.78 2.03906 15.53 0.789062 11.43 0.789062ZM5.6 10.1791C5.52 10.5191 5.21 10.7491 4.87 10.7491C4.81 10.7491 4.75 10.7391 4.69 10.7291C4.29 10.6291 4.04 10.2191 4.14 9.8191C4.44 8.6291 4.44 7.3691 4.14 6.1791C4.04 5.77906 4.28 5.36906 4.69 5.26906C5.1 5.16906 5.5 5.41906 5.6 5.81906C5.96 7.2491 5.96 8.7491 5.6 10.1791ZM9.1 10.1791C9.02 10.5191 8.71 10.7491 8.37 10.7491C8.31 10.7491 8.25 10.7391 8.19 10.7291C7.79 10.6291 7.54 10.2191 7.64 9.8191C7.94 8.6291 7.94 7.3691 7.64 6.1791C7.54 5.77906 7.78 5.36906 8.19 5.26906C8.59 5.16906 9 5.40906 9.1 5.81906C9.46 7.2491 9.46 8.7491 9.1 10.1791Z"
            fill={color}
          />
        </>
      ) : (
